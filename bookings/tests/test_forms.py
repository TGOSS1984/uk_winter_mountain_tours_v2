...
class BookingFormTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.guide_free = Guide.objects.create(
            name="Free Guide", email="free@example.com"
        )
        cls.guide_taken = Guide.objects.create(
            name="Taken Guide", email="taken@example.com"
        )
    ...
    def test_logged_in_user_fields_hidden_not_required_and_user_attached(self):
        ...
        self.assertEqual(
            form.fields["customer_name"].widget.__class__.__name__, "HiddenInput"
        )
        self.assertEqual(
            form.fields["customer_email"].widget.__class__.__name__, "HiddenInput"
        )
